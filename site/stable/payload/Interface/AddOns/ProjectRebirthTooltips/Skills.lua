...
local function CreateInterface()
    ...
    title:SetText("Project Rebirth")
    title:SetTextColor(0.45, 0.90, 1.00)

    local subtitle = panel:CreateFontString(nil, "OVERLAY", "GameFontHighlightSmall")
    subtitle:SetPoint("TOPLEFT", panel, "TOPLEFT", 20, -44)
    subtitle:SetText("Skills, Heritage, Manifestations, and Life progression")
    ...
    if MainMenuBar then
        ...
        toggleButton:SetScript("OnEnter", function(self)
            ...
            GameTooltip:AddLine("Project Rebirth", 0.45, 0.90, 1.00)
