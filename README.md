...
update to 1.6.2. Later launcher updates prompt and install inside the launcher,
without redirecting to GitHub. All upgrading users must also update the addons
...
to 1.6.2. Version 1.6.1 can self-update; for 1.6.0 and older, download the 1.6.2 ZIP,
extract it into a new folder and run it. Your client selection is retained. No password
...
**1.6.0 and older:** download the 1.6.2 ZIP once, close the old launcher, extract
...
current. The current minimum is **1.6.2**: 1.6.1 users can self-update, while
1.6.0 and older need a **one-time manual upgrade to 1.6.2**.
